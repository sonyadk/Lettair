...
public class CustomAuthActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private com.example.lettair.TokenBroadcastReceiver mTokenReceiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTokenReceiver = new com.example.lettair.TokenBroadcastReceiver() {
            @Override
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mTokenReceiver, com.example.lettair.TokenBroadcastReceiver.getFilter());
    }
